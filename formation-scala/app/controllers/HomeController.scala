...
@Singleton
class UserController @Inject()(authAction: AuthenticatedAction,
...
@Singleton
class AuthenticatedAction @Inject()(val parser: BodyParsers.Default)(implicit mongo: ReactiveMongoApi, val executionContext: ExecutionContext) extends ActionBuilder[UserContext, AnyContent] {
